...
public class BasicAppShareActivity extends AppCompatActivity
    ...
    public void onDenied(int i, String[] strings) {
        Toast.makeText(this,
                "권한 사용을 하지 않으면 기능을 사용 못함",
                Toast.LENGTH_LONG).show();
    }
    //권한을 허용했을 때 호출되는 메소드 : AutoPermissionListener의 메소드
    @Override
    ...
    public void onRequestPermissionsResult(
        ...
        //권한 요청 결과를 AutoPermission에 전송해서
        //메소드를 호출하도록 해줍니다.
